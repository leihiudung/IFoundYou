...
@interface LightCheckupViewMode() <AVCaptureVideoDataOutputSampleBufferDelegate> {
    int _count;
}
...
@implementation LightCheckupViewMode


+ (instancetype)share {
    static dispatch_once_t onceToken;
    static LightCheckupViewMode *lightCheck;
    dispatch_once(&onceToken, ^{
        lightCheck = [[LightCheckupViewMode alloc]init];
